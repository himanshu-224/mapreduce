...
userprog: src/userprog.cpp src/objs/mapReduce.o src/objs/chunkCreation.o src/objs/pugixml.o src/dataStruc.h src/objs/logging.o
	mpic++ -std=c++0x -pthread -c src/userprog.cpp -o src/objs/userprog.o
	mpic++ -std=c++0x -pthread -o mapreduce src/objs/userprog.o src/objs/mapReduce.o src/objs/chunkCreation.o src/objs/pugixml.o src/dataStruc.h src/objs/logging.o
...
src/objs/mapReduce.o : src/mapReduce.cpp src/mapReduce.h src/dataStruc.h
	mpic++ -std=c++0x -pthread -c src/mapReduce.cpp -o src/objs/mapReduce.o	
