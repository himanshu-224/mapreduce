...
userprog: src/userprog.cpp src/objs/mapReduce.o src/keyValue.h src/objs/chunkCreation.o src/objs/pugixml.o src/dataStruc.h src/objs/logging.o 
	$(MPICC) -std=c++0x -pthread -c src/userprog.cpp -o src/objs/userprog.o
	$(MPICC) -std=c++0x -pthread -o mapreduce src/objs/userprog.o src/objs/mapReduce.o src/objs/chunkCreation.o src/objs/pugixml.o src/dataStruc.h src/objs/logging.o src/keyValue.h
