...
createChunks::createChunks(int num,int csize,string str,DataType type, string dir="/mnt/mpidata/")
    {
        numMaps=num;
        chunkSize=csize;
        dirFile=str;
...
int main(int argc, char** argv)
{
  ...
  vector<ChunkInfo> chunks;
	...
	createChunks obj = createChunks(numMaps,chunkSize,inputDirFile,dataType, mntDir);
